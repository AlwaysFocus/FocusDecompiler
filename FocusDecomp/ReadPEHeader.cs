...
namespace FocusDecomp
{
    class ReadPEHeader
    {
        ...
        public ReadPEHeader(string filePath)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static ReadPEHeader GetCallingAssemblyHeader()
        {
            ...
            return new ReadPEHeader(filePath);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static ReadPEHeader GetAssemblyHeader()
        {
            // Get the path to the calling assembly, which is the path to the
            // DLL or EXE that we want the time of
            string filePath = System.Reflection.Assembly.GetAssembly(typeof(ReadPEHeader)).Location;
